...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('master_approvals', function (Blueprint $table) {
            ...
            $table->string('master_approvals_name', 225)->nullable();
            $table->string('department_code', 225)->nullable(); // Foreign key to departments table
            $table->string('division_code', 225)->nullable();  // Foreign key to divisions table
            $table->string('level_code', 225)->nullable();      // Foreign key to levels table
            $table->timestamp('master_approvals_created_at')->useCurrent()->nullable();
