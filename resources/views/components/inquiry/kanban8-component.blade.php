<div class="card">
    <div class="card-body">
        <div class="kanban-board-header">
            <h5>Waiting Approval Batal</h5>
        </div>
        <div id="task-waiting-approval-batal">
            <div id="waiting-approval-batal" class="kanban-column">
                <input type="hidden" value="STATUS0008" class="inquiry-stage">
                @foreach($data as $row)
                @php
