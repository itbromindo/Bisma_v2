                    ...
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                @if ($usr->can('template_win_loses.create'))
                                                    ...
                                                    <tbody id="tableBody">
                                                        @foreach ($template_win_loses as $template_win_lose)
                                                            ...
                                                            <td scope="row" class="text-center">
                                                                ...
                                                                <td class="text-center">{{ Str::words($template_win_lose->template_win_loses_code, 10, '...') }}</td>
                                                                 <td class="text-center">{{ Str::words($template_win_lose->template_win_loses_title, 10, '...') }}</td>
                                                                 <td class="text-center">{{ Str::words($template_win_lose->template_win_loses_text, 10, '...') }}</td>
                                                                 <td class="text-left">{{ Str::words($template_win_lose->template_win_loses_notes, 10, '...') }}</td>
                                                                <td class="text-center">
                                                                    <div class="d-flex justify-content-center gap-2">
                                                                        @if ($usr->can('template_win_loses.delete'))
                        ...
                        response.template_win_loses.data.forEach(function (template_win_lose, index) {
                            $('#tableBody').append(`
                                <tr>
                                    ...
                                    <td class="text-center">${ truncateText(template_win_lose.template_win_loses_code, 10, '...')}</td>
                                    <td class="text-center">${ truncateText(template_win_lose.template_win_loses_title, 10, '...')}</td>
                                    <td class="text-center">${ truncateText(template_win_lose.template_win_loses_text, 10, '...')}</td>
                                    
                                    <td class="text-left">${ truncateText(template_win_lose.template_win_loses_notes, 10, '...') ?? '-'}</td>
                                    <td class="text-center">
                                        <div class="d-flex justify-content-center gap-2">
                                            @if ($usr->can('template_win_loses.delete'))
                                            <button class="btn btn-light btn-sm border border-danger text-danger" title="Delete" onclick="delete_data('${template_win_lose.template_win_loses_id}')">
