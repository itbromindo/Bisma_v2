                                                    ...
                                                    <tbody id="tableBody">
                                                        @foreach ($checklists as $checklist)
                                                            ...
                                                            <td scope="row" class="text-center">
                                                                ...
                                                                <td class="text-center">{{ Str::words($checklist->checklist_code, 10, '...') }}</td>
                                                                <td class="text-center">{{ Str::words($checklist->checklist_items, 10, '...') }}</td>
                                                                <td class="text-left">{{ Str::words($checklist->checklist_notes, 10, '...') }}</td>
                                                                <td class="text-center">{{ Str::words($checklist->pillar->pillar_items, 10, '...') }}</td>
                                                                <td class="text-center">
                                                                    <div class="d-flex justify-content-center gap-2">
                                                                        @if ($usr->can('checklists.delete'))
                        ...
                        response.checklists.data.forEach(function (checklist, index) {
                            $('#tableBody').append(`
                                <tr>
                                    ...
                                    <td class="text-center">${ truncateText(checklist.checklist_code, 10, '...')}</td>
                                    <td class="text-center">${ truncateText(checklist.checklist_items, 10, '...')}</td>
                                    <td class="text-left">${ truncateText(checklist.checklist_notes, 10, '...') ?? '-'}</td>
