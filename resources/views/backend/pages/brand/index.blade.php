                        ...
                        <div class="card-header d-flex justify-content-between align-items-center">
                            ...
                            <div class="d-flex align-items-center">
                                <div class="app-main-search me-2">
                                    <form action="/admin/brand" method="GET" class="d-flex">
                                        ...
                                        <nav aria-label="Page navigation">
                                            <ul class="pagination justify-content-end">
                                                ...
                                                <li class="page-item {{ $brand->onFirstPage() ? 'disabled' : '' }}">
                                                    <a class="page-link" href="{{ $brand->appends(['search' => $search ?? request('search')])->previousPageUrl() }}" aria-label="Previous">
                                                        <i class="ph-arrow-left"></i>
                                                    </a>
                                                </li>

                                                <!-- Page Number Links -->
                                                @foreach ($brand->onEachSide(0)->appends(['search' => $search ?? request('search')])->links()->elements[0] as $page => $url)
                                                    <li class="page-item {{ $brand->currentPage() == $page ? 'active' : '' }}">
                                                ...
                                                <li class="page-item {{ $brand->hasMorePages() ? '' : 'disabled' }}">
                                                    <a class="page-link" href="{{ $brand->appends(['search' => $search ?? request('search')])->nextPageUrl() }}" aria-label="Next">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form>
                    ...
                    <div class="fromGroup mb-3">
                        <label>Note</label>
                        <textarea class="form-control" name="brand_notes" id="brand_notes" placeholder="Catatan"></textarea>
                    </div>
                </form>
            </div>
...
<script>
    ...
    function clearform() {
        ...
        document.getElementById('brand_notes').value = '';
    ...
    function saveInput() {
        ...
        postdata.append('brand_name', document.getElementById('brand_name').value); 
        postdata.append('brand_notes', document.getElementById('brand_notes').value); 
    ...
    function showedit(id){
        $.ajax({
            ...
            success: function (data) {
                ...
                document.getElementById('brand_notes').value = data.brand_notes;
