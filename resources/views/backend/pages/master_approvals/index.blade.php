                                    ...
                                    <div class="col-lg-12">
                                        <nav aria-label="Page navigation">
                                            <ul class="pagination justify-content-end">
                                                <!-- Previous Page Link -->
                                                <li class="page-item {{ $masterApprovals->onFirstPage() ? 'disabled' : '' }}">
                                                    <a class="page-link" href="{{ $masterApprovals->appends(['search' => $search ?? request('search')])->previousPageUrl() }}" aria-label="Previous">
                                                ...
                                                @foreach ($masterApprovals->onEachSide(0)->appends(['search' => $search ?? request('search')])->links()->elements[0] as $page => $url)
                                                    <li class="page-item {{ $masterApprovals->currentPage() == $page ? 'active' : '' }}">
                                                        <a class="page-link" href="{{ $url }}">{{ sprintf('%02d', $page) }}</a>
                                                    </li>
                                                @endforeach

                                                <!-- Next Page Link -->
                                                <li class="page-item {{ $masterApprovals->hasMorePages() ? '' : 'disabled' }}">
                                                    <a class="page-link" href="{{ $masterApprovals->appends(['search' => $search ?? request('search')])->nextPageUrl() }}" aria-label="Next">
            ...
            <div class="modal-body">
                <form>
                    ...
                    <div class="fromGroup mb-3">
                        ...
                        <input class="form-control" type="text" id="master_approvals_approval_name" placeholder="Master Approval Name" />
                    </div>
                    <div class="fromGroup mb-3">
                        <label>Notes</label>
